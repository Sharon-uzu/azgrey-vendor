  ...
  return (
    <div>
      ...
      >
        ...
        {/* <div className="w-5/12 text-start pl-3">
          <label htmlFor="" className="pl-3">Riding Experience</label>
        ...
        <div className="w-5/12 text-start pl-3">
          <label htmlFor="" className="pl-4">Are you ready to work everyday?</label>
        ...
        <div className="w-10/12 ml-6 text-start mb-2"> 
          <label htmlFor="">Upload your National ID</label>

          <div className="border-solid border-rgb(59 130 246 / 0.5) border-2 w-6/12 bg-transparent rounded-md pl-3 h-10 outline-none flex items-center">
            <input
              type="file"
              name="image"
              accept="image/*"
        ...
        <input
          type="submit"
          value="SignUp"
          className="border-solid border-black border-4 w-2/5 mx-auto py-3 px-4 rounded-xl hover:bg-black cursor-pointer hover:text-white font-bold"
        />
