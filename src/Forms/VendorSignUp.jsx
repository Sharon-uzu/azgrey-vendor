    ...
    <div>
      ...
      >
        ...
        <input
          ...
          className="border-solid border-rgb(59 130 246 / 0.5) border-2 w-5/12 mx-auto bg-transparent rounded-md pl-3 h-10 outline-none"
          name="fullname"
        ...
        <div className="w-5/12 ml-6 text-start mb-2"> 
          <label htmlFor="">Upload Business certificate</label>

          <div className="border-solid border-rgb(59 130 246 / 0.5) border-2 w-full bg-transparent rounded-md pl-3 h-10 outline-none flex items-center">
            <input
              type="file"
              name="image"
              accept="image/*"
        ...
        <div className="w-6/12 ml-6 text-start mb-2"> 
          <label htmlFor="" className="pl-6 ml-2">Upload Business certificate</label>

          <select name="role" id="" value={formData.role} onChange={e=> handleInputChange(e)}
          className="border-solid border-rgb(59 130 246 / 0.5) border-2 w-10/12 m-auto bg-transparent rounded-md pl-3 h-10 outline-none flex items-center">
            {/* <input
              type="file"
              name="image"
              accept="image/*"
        ...
        {/* <div className="w-6/12 text-start mb-2"> 
          <label htmlFor="">Upload Business certificate</label>

           <div className=" w-11/12  m-auto mx-2 bg-transparent rounded-md pl-3 h-10 outline-none flex items-center">
            

            <select name="role" id="" value={formData.role} onChange={e=> handleInputChange(e)}
              className="border-solid border-rgb(59 130 246 / 0.5)  border-2 w-full mx-auto bg-transparent rounded-md pl-3 h-10 outline-none">
              <option value=" vendor">Vendor</option>
              <option value="rider">Rider</option>
              <option value="admin">Admin</option>
            </select>
